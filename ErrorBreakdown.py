...
model.load_weights('./weights/31. NUbots - Capped50 - train on 8Locations square/my_weights_Res3_NU25')
model.compile(optimizer=Adam(lr=1e-4, epsilon=1e-10), loss=CustomImageGen.geo_loss, metrics=[CustomImageGen.xyz_error])


#####################################################################
# Test
x_test_files = CustomImageGen.list_of_files("NUbots",".\\Capped50\\1Location-centre")
